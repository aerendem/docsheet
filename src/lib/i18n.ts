...
const en = {
  ...
  matcher_own_count_one: "{n} pair",
  matcher_own_count_many: "{n} pairs",
  ...
  matcher_extra_price: "List price",
...
const tr: Record<StringKey, string> = {
  ...
  matcher_own_count_one: "{n} çift",
  matcher_own_count_many: "{n} çift",
  ...
  matcher_extra_price: "Liste fiyatı",
